...
})();if(window.PerformanceObserver){ttiPolyfill.getFirstConsistentlyInteractive().then(function(a){ga('send','event',{eventCategory:'Performance Metrics',eventAction:'TTI',eventValue:a.toFixed(2),nonInteraction:!0})});var observer=new PerformanceObserver(function(a){var _iteratorNormalCompletion=!0,_didIteratorError=!1,_iteratorError=void 0;try{for(var c,b=a.getEntries()[Symbol.iterator]();!(_iteratorNormalCompletion=(c=b.next()).done);_iteratorNormalCompletion=!0){var d=c.value,e=d.name,f=Math.round(d.startTime+d.duration);ga('send','event',{eventCategory:'Performance Metrics',eventAction:e,eventValue:f,nonInteraction:!0})}}catch(g){_didIteratorError=!0,_iteratorError=g}finally{try{!_iteratorNormalCompletion&&b.return&&b.return()}finally{if(_didIteratorError)throw _iteratorError}}});observer.observe({entryTypes:['paint']})}